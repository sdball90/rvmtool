 ...
 */
FARPROC WINAPI rvmtoolDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = rvmtoolDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = rvmtoolDelayLoadWin32FailureHook;
#endif
